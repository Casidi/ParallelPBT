...
def main(hp, model_id, save_base_dir, data_dir, train_epochs, epoch_index):
    ...
    if os.path.isfile(os.path.join(data_dir, 'train-images-idx3-ubyte.gz')) != True:
        download_file(data_dir, 'http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz')
    if os.path.isfile(os.path.join(data_dir, 'train-labels-idx1-ubyte.gz')) != True:
        download_file(data_dir, 'http://yann.lecun.com/exdb/mnist/train-labels-idx1-ubyte.gz')
    if os.path.isfile(os.path.join(data_dir, 't10k-images-idx3-ubyte.gz')) != True:
        download_file(data_dir, 'http://yann.lecun.com/exdb/mnist/t10k-images-idx3-ubyte.gz')
    if os.path.isfile(os.path.join(data_dir, 't10k-labels-idx1-ubyte.gz')) != True:
        download_file(data_dir, 'http://yann.lecun.com/exdb/mnist/t10k-labels-idx1-ubyte.gz')
